...
export function InvoiceReferenceDocument(props: {
  ...
  return (
    ...
    >
      <header
        className={props.markerClasses.keepWithNext}
        style={{
      ...
      >
        <article className={props.markerClasses.avoidBreak}>
      ...
      <section className={props.markerClasses.avoidBreak}>
        ...
        <article>
          ...
          {props.payload.sections.map((section, index) => (
            <section
              ...
              className={index === 2 ? props.markerClasses.pageBreakBefore : undefined}
              style={{
                marginTop: "14px",
                padding: "12px",
                border: "1px solid #e2e8f0",
      ...
      {props.payload.notes ? (
        <section
          className={props.markerClasses.pageBreakBefore}
          style={{
            marginTop: "20px",
            padding: "16px",
